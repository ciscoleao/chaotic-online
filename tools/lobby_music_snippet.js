/* ===== v181 — MÚSICA DO PÁTIO (7 faixas por mapa) =====
 ...
 * Começa no 1º gesto, baixinho (default 40 + fade 4s). */
...
const LobbyMusic = {
  ...
  droneNodes: [], windNodes: null, switchToken: 0, DIP_MS: 1200,
...
function initLobbyMusic() {
  try {
    ...
    bindImmediateButton('opt-music-mute', function() {
    ...
    try {
      ...
      LobbyMusic.watchTimer = setInterval(function() {
        try {
          if (!LobbyMusic.started || LobbyMusic.manual) return;
          LobbyMusic.switchTrack(musicWantedTrack());
        } catch (e) {}
      }, 1000);
    } catch (e) {}
  } catch (e) {}
