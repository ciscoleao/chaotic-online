...
const GAME_FILE = fs.existsSync(LOBBY_FILE) ? LOBBY_FILE : (fs.existsSync(path.join(ROOT, 'chaotic_idleworld_v123.html')) ? path.join(ROOT, 'chaotic_idleworld_v123.html') : path.join(ROOT, 'chaotic_idleworld_v122.html'));
console.log('[boot] /game serve: ' + GAME_FILE + (GAME_FILE === LOBBY_FILE ? ' (lobby novo)' : ' (fallback v123/v122)'));
